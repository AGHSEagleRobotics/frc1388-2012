...
Shooter::Shooter() : ShooterBase()
{
	...
	pidTopAxel = new SendablePIDController(0.005, 0.0, 0.0, topAxelEncoder, topAxel);
	pidBottomAxel = new SendablePIDController(0.005, 0.0, 0.0, bottomAxelEncoder, bottomAxel);
//	conveyorBelt = new Victor(CONVEYOR_BELT_VICTOR);
//	passed = new DigitalInput(BALL_PASSED);
	pidTopAxel->SetOutputRange(0,0.4);
